...
public class MainActivity extends AppCompatActivity {
    ...
    private long addGuest(String nameGuest, int sizeParty){
        ContentValues cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, nameGuest);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, sizeParty);
