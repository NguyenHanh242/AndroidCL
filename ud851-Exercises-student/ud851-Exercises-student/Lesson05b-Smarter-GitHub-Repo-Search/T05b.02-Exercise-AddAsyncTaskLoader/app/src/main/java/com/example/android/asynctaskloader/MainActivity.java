...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private void makeGithubSearchQuery() {
        ...
        bundel.putString(SEARCH_QUERY_URL_EXTRA, githubSearchUrl.toString());
        ...
        Loader<String> githubSearch = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
        if (githubSearch == null){
            loaderManager.initLoader(GITHUB_SEARCH_LOADER, bundel, this);
        } else {
            loaderManager.restartLoader(GITHUB_SEARCH_LOADER, bundel, this);
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    URL urlGithub = new URL(searchUrl);
                    return NetworkUtils.getResponseFromHttpUrl(urlGithub);
