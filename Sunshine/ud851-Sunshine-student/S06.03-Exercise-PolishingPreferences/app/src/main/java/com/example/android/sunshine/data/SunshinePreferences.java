...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sharedPreferences.getString(keyLocation, defaultLocation);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String keyMetric = context.getString(R.string.pref_units_key);
        String defaultMetric = context.getString(R.string.pref_units_metric);
        String prefUnits = sharedPreferences.getString(keyMetric, defaultMetric);
